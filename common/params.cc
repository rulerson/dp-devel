...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"dp_lateral_road_edge_detected", PERSISTENT},
    ...
    {"dp_toyota_debug_bsm", PERSISTENT},
    {"dp_mapd", PERSISTENT},
    ...
    {"dp_lateral_alt", PERSISTENT},
    {"dp_lateral_alt_speed", PERSISTENT},
    {"dp_lateral_alt_ctrl", PERSISTENT},
    {"dp_lateral_alt_lanelines", PERSISTENT},
    {"dp_lateral_alt_camera_offset", PERSISTENT},
    {"dp_lateral_alt_path_offset", PERSISTENT},
    ...
    {"dp_upload_ignored", PERSISTENT},
    {"local_trip_count_total", PERSISTENT},
    {"local_trip_meter_total", PERSISTENT},
    {"local_trip_min_total", PERSISTENT},
    {"dp_lateral_lc_manual", PERSISTENT},
};
