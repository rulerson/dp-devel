...
from selfdrive.boardd.boardd import can_list_to_can_capnp  # pylint: disable=no-name-in-module,import-error
...
def can_function(pm, speed, angle, idx, cruise_button=0, is_engaged=0):
  ...
  msg.append(packer.make_can_msg("STEER_STATUS", 0, {"STEER_TORQUE_SENSOR": 1201}))
  msg.append(packer.make_can_msg("STEERING_SENSORS", 0, {"STEER_ANGLE": angle_to_sangle(angle)}))
  msg.append(packer.make_can_msg("VSA_STATUS", 0, {}))
  msg.append(packer.make_can_msg("STANDSTILL", 0, {}))
  ...
  msg.append(packer.make_can_msg("CRUISE", 0, {"CRUISE_SPEED_PCM": speed}))
